...
This small webapp lets you view your Memability/Memz.co notes in all their hierarchical glory.

To use this, first download a JSON of your Memability/Memz.co notes from Google Tasks, and place it in this project's root directory with the name `Memability.json`.
